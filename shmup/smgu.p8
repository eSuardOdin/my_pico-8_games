...
function drw_enemies()
	if(#e_table!=0)then
		for e in all(e_table)do
			...
			if(e.type==2and e.y>5 and e.y<105)then
			--draw firing circle
				if(e.load>e.rate-6)then
					circfill(e.x+4,e.y+6,e.rate-e.load,7)
				end
				--draw loading enemy
				if(e.load<=5)then
...

